...
<head>
    ...
    <title>Verify Your Email - CheckMySite</title>
</head>
                ...
                <table width="100%" style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; font-size: 16px; line-height: 1.6;">
                            ...
                            <p>Welcome to CheckMySite! To get started with your account, please verify your email address by clicking the button below:</p>
                            ...
                            <p>This verification link will expire in 24 hours. If you did not create an account with CheckMySite, please disregard this email.</p>
